# qutemacs - un conjunto de enlaces Emacs simples y preconfigurados para qutebrowser
#
# El objetivo de este conjunto de enlaces no es proporcionar enlaces para absolutamente
# todo, sino proporcionar un punto de partida estable para que la gente haga sus
# propios enlaces.
#
# Instalación:
#
# 1. Copia este archivo o agrega este repositorio como un submódulo a tus dotfiles.
# 2. Agrega esta línea a tu config.py y apunta la ruta a este archivo:
...
# desactiva el modo insertar por completo
c.input.insert_mode.auto_enter = False
c.input.insert_mode.auto_leave = False
c.input.insert_mode.plugins = False

# Reenvía las teclas sin enlazar
