...
class NotificationWindow(Window):
    def __init__(self, notifs_service: Notifications, **kwargs):
        super().__init__(
            ...
            anchor="top right",
            margin="60px 18px 10px 0px",  # Margen perfecto debajo de tu barra de Qtile
