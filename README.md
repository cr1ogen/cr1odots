...
| `Mod + Ctrl + R` | Reiniciar Qtile por completo (Recargar configs) |
| `Mod + Ctrl + Q` | Salir de la sesión de Qtile |
...
*   **end-4 ([dots-hyprland](https://github.com/end-4/dots-hyprland)):** Por la excelente plantilla de generación de colores de Matugen, la cual utilizo para tematizar automáticamente las interfaces **GTK-3** y **GTK-4**.
