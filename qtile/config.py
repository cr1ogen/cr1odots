...
keys = [
      ...
      Key([mod], "d", lazy.spawn("rofi -show run -theme dmenu"), desc="Launch Rofi in Run mode"),
      Key([mod], "r", lazy.spawn("rofi -show drun -theme dmenu-list-ex -show-icons"), desc="Launch Rofi in Drun mode"),
      ...
      Key([mod, "shift"], "backslash", lazy.spawn("nemo"), desc="Spawn the file manager"),
      Key([mod], "backslash", lazy.spawn("firefox"), desc="Web Browser"),

      # Quick Launch Applications
      KeyChord([mod], "a", [
          Key([mod], "f", lazy.spawn("firefox"), desc="Web Browser"),
